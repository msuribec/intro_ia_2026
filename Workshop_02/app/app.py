...
with col1:
    st.info(
        "**📊 Regresión**\n\n"
        "Pipeline completo de regresión sobre el dataset de costos médicos (Insurance). "
...
with col2:
    st.info(
        "**📈 Clasificación**\n\n"
        "Pipeline de clasificación multiclase sobre Digits (sklearn). "
